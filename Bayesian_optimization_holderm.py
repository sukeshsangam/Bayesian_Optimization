...
def holderm(x):
	...
	fact1 = math.sin(x11)*math.cos(x22)
	fact2 = math.exp(abs(1 - math.sqrt((x11)**2+(x22)**2)/math.pi))
...
objective = GPyOpt.core.task.SingleObjective(holderm)
...
print(bo.x_opt)
#print(func)
print(holderm_f(bo.x_opt))


bounds = [(-10, 10), (-10, 10)]
result = differential_evolution(holderm_f, bounds)
print(result.x)
print(result.fun)